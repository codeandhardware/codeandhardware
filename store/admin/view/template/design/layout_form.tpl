            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-4 col-sm-12">
				...
				<table id="module-footerbefore" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-center"><?php echo $text_footerbefore; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
                    <?php if ($layout_module['position'] == 'footerbefore') { ?>
                    <tr id="module-row<?php echo $module_row; ?>">
                      <td class="text-left"><div class="input-group">
                          <select name="layout_module[<?php echo $module_row; ?>][code]" class="form-control input-sm">
                            <?php foreach ($extensions as $extension) { ?>
                  ...
                  <tfoot>
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('footerbefore');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom,#module-footerleft,#module-footertopinner,#module-headertop,#module-headertopleft,#module-homecategory').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom, #module-footerleft ,#module-footertopinner,#module-headertop,#module-headertopleft,#module-homecategory').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>