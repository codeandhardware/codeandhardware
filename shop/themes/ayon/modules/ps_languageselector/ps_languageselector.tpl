...
<div class="language_selector mob-select">
  <div class="language-selector-wrapper">
    <span id="language-selector-label" class="language-selector-label" class="hidden-md-up">{l s='Language:' d='Shop.Theme.Global'}</span>
    <div class="language-selector dropdown js-dropdown">
      <button data-toggle="dropdown" class="hidden-sm-down btn-unstyle" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}">
        <span class="expand-more">
          {if isset($roythemes.nc_cll) && $roythemes.nc_cll == "1"}{$current_language.name_simple}{else}{$language.iso_code}{/if}
        </span>
