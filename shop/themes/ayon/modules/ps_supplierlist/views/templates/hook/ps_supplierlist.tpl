...
<div id="search_filters_suppliers" class="sidebar-block">
  <section class="facet">
    ...
    <div class="title clearfix hidden-md-up" data-target="#side_supps" data-toggle="collapse">
      <span class="h3">{l s='Suppliers' d='Shop.Theme.Catalog'}</span>
    ...
    <div id="side_supps" class="sidebar-content collapse">
      {if $suppliers}
