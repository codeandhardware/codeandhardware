                    ...
                    <div class="roytc_navigation">
                        <ul id="#sidenav" class="ulnav">
                            ...
                            <li class="rtc_menu3 tab" id="tab_menu_3">
                                <a data-toggle="tab" title="Homepage Content" href="#tab-homepage" class="tworows"><i class="icon-monitor"></i><span>4</span>Homepage <br/>Content</a>
                            </li>
                            <li class="rtc_menu4 tab" id="tab_menu_4">
                                <a data-toggle="tab" title="Page and sidebar" href="#tab-page" class="tworows"><i class="icon-file-text upper"></i><span>5</span>Shop Pages <br />Content</a>
                            </li>
                    ...
                    <div class="section hide" id="tab-layout1">
                        ...
                        <div class="roytc_row ds_wrap" style="margin-right:-22px;">
                              <div class="margin-form" style="margin-bottom:0; display:inline-block">
                                    ...
                                    <label class="ds_demo mercury" for="select_demo1"> <span>core</span></label>
...
// FONTS BY class
      ...
      $arr = array($fontHeadings, $fontButtons, $fontText, $fontPrice);
      $filtered = array();
        ...
        if (Configuration::get('NC_MOB_CAT') =="2") {
            $css .= '
                  @media (max-width:574px) {
                    #category #products #js-product-list .product-item {
                        width:50%;
                        flex-grow:1;
                        padding:0 10px;
                    }
                    #category #products #js-product-list .product-item .comments_note,
                    #category #products #js-product-list .product-item .countcontainer {
                        display:none;
                    }
                    #category #products #js-product-list .thumbnail-container .add_to_cart {
                        padding: 8px 10px;
                        font-size: 14px;
                        line-height:14px;
                    }
...
// ****************  Typography styles start
            ...
            #ui_prod .ui_name, #products .product-title a, .featured-products .product-title a, .product-accessories .product-title a, .product-miniature .product-title a {
              ...
              line-height: ' . Configuration::get('RC_FS_CAT_NAME') . 'px;
        ...
        if (Configuration::get('RC_I_BG_FOCUS')) {
            $css .= '.products-sort-order .select-title, .products-sort-order .dropdown-menu, .product-quantity .input-group-btn-vertical .btn:hover, .form-control:focus, input:focus, textarea:focus, .form-control-select:focus, body select.form-control:not([size]):not([multiple]):focus, input.uniform-input:focus, select.uniform-multiselect:focus, textarea.uniform:focus { background-color: ' . Configuration::get('RC_I_BG_FOCUS') . ' } '; }
        if (Configuration::get('RC_I_B_FOCUS')) {
            $css .= '.custom-radio:hover, .custom-checkbox input[type=checkbox]:hover+span, .product-quantity .input-group-btn-vertical .btn:hover, .form-control:focus, input:focus, textarea:focus, .form-control-select:focus, body select.form-control:not([size]):not([multiple]):focus, input.uniform-input:focus, select.uniform-multiselect:focus, textarea.uniform:focus { border-color: ' . Configuration::get('RC_I_B_FOCUS') . '!important; z-index:2; } '; }
...
// ****************  PRODUCT PAGE styles start
        ...
        if (Configuration::get('RC_PP_TABS_BG_SW') == "1") {
            $css .= '
            #product .tabs { background: ' . Configuration::get('RC_PP_TABS_BG') . '; padding-top:6rem; padding-bottom:6rem; }
            @media (max-width: 767px) {
              .tabs>.container {
                padding-left: 40px;
                padding-right: 40px;
